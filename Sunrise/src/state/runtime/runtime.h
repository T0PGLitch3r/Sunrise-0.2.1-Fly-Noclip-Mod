...
/** Persists authored equipped gear and character inventory to saved_loadout.bin. */
[[nodiscard]] bool persist_saved_loadout() noexcept;

/** Restores saved equipped gear and character inventory; accepts v1 and v2 files. */
[[nodiscard]] bool restore_saved_loadout(AccountState& account) noexcept;
